...
// CIR: !rec_Base = !cir.struct<class "Base" {data !cir.vptr}>
// CIR: !rec_Derived = !cir.struct<class "Derived" {data !rec_Base}>
// CIR: !rec_DerivedFinal = !cir.struct<class "DerivedFinal" {data !rec_Base}>
