...
// LLVM: %[[ARR_ELEM_1_PTR:.*]] = getelementptr inbounds i32, ptr %[[ARR_ELEM_0_PTR]], i64 1
// LLVM: store i32 20, ptr %[[ARR_ELEM_1_PTR]], align 4
// LLVM: %[[ARR_ELEM_2_PTR:.*]] = getelementptr inbounds i32, ptr %[[ARR_ELEM_0_PTR]], i64 2
...
// LLVM: %[[ARR_END:.*]] = getelementptr inbounds nuw [3 x i32], ptr %[[ARR_ADDR]], i64 3
