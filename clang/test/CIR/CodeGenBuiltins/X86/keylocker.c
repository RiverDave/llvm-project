...
// CIR: !rec_anon_struct = !cir.struct<{data !u8i, data !cir.vector<2 x !s64i>}>
// CIR: !rec_anon_struct1 = !cir.struct<{data !u8i, data !cir.vector<2 x !s64i>, data !cir.vector<2 x !s64i>, data !cir.vector<2 x !s64i>, data !cir.vector<2 x !s64i>, data !cir.vector<2 x !s64i>, data !cir.vector<2 x !s64i>, data !cir.vector<2 x !s64i>, data !cir.vector<2 x !s64i>}>
// CIR: !rec_anon_struct2 = !cir.struct<{data !u32i, data !cir.vector<2 x !u64i>, data !cir.vector<2 x !u64i>, data !cir.vector<2 x !u64i>, data !cir.vector<2 x !u64i>, data !cir.vector<2 x !u64i>, data !cir.vector<2 x !u64i>}>
// CIR: !rec_anon_struct3 = !cir.struct<{data !u32i, data !cir.vector<2 x !u64i>, data !cir.vector<2 x !u64i>, data !cir.vector<2 x !u64i>, data !cir.vector<2 x !u64i>, data !cir.vector<2 x !u64i>, data !cir.vector<2 x !u64i>, data !cir.vector<2 x !u64i>}>
