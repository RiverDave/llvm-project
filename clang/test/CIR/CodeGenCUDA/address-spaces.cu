...
// CIR-PRE: cir.global external  lang_address_space(offload_local) @k = #cir.undef
...
// CIR-PRE: cir.global external  lang_address_space(offload_local) @b = #cir.undef : !cir.float
// CIR-POST: cir.global external  target_address_space(3) @b = #cir.undef : !cir.float
